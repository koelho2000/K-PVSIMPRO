...
const INITIAL_PROJECT: ProjectState = {
  ...
  systemConfig: {
    ...
    cableDcMeters: 20, // Total default
    cableAcMeters: 10,
    cableDcPanelsToBox: 15,
    cableDcBoxToInverter: 5
  },
  ...
  return (
    <div className="flex h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <main className="flex-1 overflow-auto p-8 relative print:p-0 print:overflow-visible">
        ...
        {activeTab === 'budget' && <BudgetEditor project={project} onUpdate={handleBudgetUpdate} onUpdateSettings={(s) => setProject(p => ({...p, financialSettings: {...p.financialSettings, ...s}}))} />}
